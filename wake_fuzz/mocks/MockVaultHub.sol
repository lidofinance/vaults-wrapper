...
contract MockVaultHub {
  ...
  /// @dev Warning! used by Accounting Oracle to calculate fees // @ audit how ? TODO
    ...
    function burnShares(address from, uint256 amount) external {
        ...
        LIDO.mock_burnExternalShares(amount);
    }
    ...
    function rebalance(address _vault, uint256 _shares) external {
        ...
        // actual implementation move eth to LIDO(stETH) and
        // # TODO maybe better to transfer to LIDO and simulate behavior.
