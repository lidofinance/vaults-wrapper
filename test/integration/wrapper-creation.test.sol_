...
contract WrapperCreationTest is Test {
    ...
    function test_initialState() public view {
        ...
        assertEq(wrapper.balanceOf(address(dw.strategy())), 0, "strategy should have no shares initially");
        assertEq(wrapper.balanceOf(address(dw.withdrawalQueue())), 0, "withdrawalQueue should have no shares initially");
        assertEq(wrapper.balanceOf(address(wrapper)), dw.CONNECT_DEPOSIT(), "Wrapper should initially hold CONNECT_DEPOSIT shares");
