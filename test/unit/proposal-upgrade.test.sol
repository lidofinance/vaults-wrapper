...
contract ProposalUpgradableTest is Test {
    ...
    function setUp() public {
        ...
        proposalUpgradableProxy =
            ProposalUpgradableHarness(address(new ERC1967Proxy(proposalUpgradableImpl, new bytes(0))));
    ...
    function test_revertOnNotProposer() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                ...
                stranger,
                proposalUpgradableProxy.UPGRADE_PROPOSER()
            )
        );
    ...
    function test_canProposeUpgrade() public {
        ProposalUpgradable.ProposalUpgradableStorage memory currentProposal =
            proposalUpgradableProxy.getCurrentUpgradeProposal();
        ...
        vm.expectEmit();
        emit ProposalUpgradable.WrapperUpgradeProposed(
            payload.newImplementation, payload.newWqImplementation, expectedHash
        );
    ...
    function test_canEnactProposal() public {
        ...
        vm.expectEmit();
        emit ProposalUpgradable.WrapperUpgradeEnacted(
            payload.newImplementation, payload.newWqImplementation, expectedHash
        );
        vm.prank(stranger);
        proposalUpgradableProxy.enactUpgrade(payload);
