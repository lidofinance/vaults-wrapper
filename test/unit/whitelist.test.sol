...
contract WhitelistTest is Test {
    ...
    function test_whitelistEnabled() public view {
        assertEq(wrapperWithWhitelist.whitelistEnabled(), true, "Whitelist should be enabled");
        assertEq(wrapperWithoutWhitelist.whitelistEnabled(), false, "Whitelist should be disabled");
    }
