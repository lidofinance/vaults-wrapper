...
contract DepositGasProfileTest is Test {
    ...
    function setUp() public {
        ...
        address wqImpl1 = address(new WithdrawalQueue(address(0), address(lazyOracle), 30 days, 1 days));
        ...
        address wqImpl2 = address(new WithdrawalQueue(address(0), address(lazyOracle), 30 days, 1 days));
